...
//AngelTs Modification Start
//1.
//printf is not needed here:
//extern int __cdecl printf2(const char *format, ...);
//#define printf printf2
//2.
//fprintf is needed here:
extern int __cdecl fprintf2(FILE *__restrict __stream,  const char *format, ...);
#define fprintf fprintf2
//3.
extern unsigned short stopThreadVanitygen;
//AngelTs Modification End
		...
		case 'C':
			...
			if (strcmp(optarg, "LIST")== 0) {
				fprintf(stderr,
					...
					"BQC : BBQcoin : b\n"
					"BTC : Bitcoin : 1\n"
					"BTCtest : Bitcoin Testnet : m or n\n"
					"BTCD : Bitcoin Dark : R\n"
					"CCC : Chococoin : 7\n"
					"CCN : Cannacoin : C\n"
					"CDN : Canadaecoin : C\n"
			...
			if (strcmp(optarg, "BTC")== 0) {
				fprintf(stderr,
					"Generating BTC [Bitcoin] Address\n");
					addrtype = 0;
					privtype = 128;
					break;
			}
			else
			if (strcmp(optarg, "BTCtest")== 0) {
				fprintf(stderr,
...
///AngelTs Modification
strcpy(vcp->str_pattern,argv[optind]);
