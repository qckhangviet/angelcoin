...
public:
    enum
    {
        PUBKEY_ADDRESS = 23,		// Angelcoin addresses start with A
        SCRIPT_ADDRESS = 0,			// Angelcoin addresses start with 1
        PUBKEY_ADDRESS_TEST = 83,	// Angelcoin addresses start with a
        SCRIPT_ADDRESS_TEST = 3,	// Angelcoin addresses start with 2
    };
