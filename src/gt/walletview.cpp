    ...
    walletModel(0)
{
	...
	vanitygenPlus = new VanitygenPlus();
...
void WalletView::gotoVanitygenPlus()
{
    gui->getVanitygenplusAction()->setChecked(true);
    setCurrentWidget(vanitygenPlus);
}
